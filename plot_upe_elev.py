...
ax.annotate('(a)', fontsize=8, fontweight='bold', xy=(0.05,0.90), xycoords='axes fraction',
...
ax_box.annotate('(c)', fontsize=8, fontweight='bold', xy=(0.03,0.95), xycoords='axes fraction',
           horizontalalignment='left', verticalalignment='top')

plt.savefig('/home/at15963/Dropbox/work/papers/tedstone_uavts/submission1/figures/upe_elevation_clf20190130_171930.png', dpi=300)