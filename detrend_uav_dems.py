...
blurred_xr.to_netcdf('/scratch/UAV/uav2017_dem/blur_fits_399.nc')
tmp_store = None
blurred_xr = None

# Load back in with dask
blurred = xr.open_dataset('/scratch/UAV/uav2017_dem/blur_fits_399.nc', 
	chunks={'y':2000, 'x':2000})

detrended = dems.Band1 - blurred.blurred
detrended.name = 'detrended'
detrended.to_netcdf('/scratch/UAV/uav2017_dem/dems2017_detrended_commongrid_399.nc')
detrended = None
...
detrended_mean.to_netcdf('/scratch/UAV/uav2017_dem/dems2017_detrendedmean_commongrid_399.nc')
detrended_mean = None
detrended_mean = xr.open_dataset('/scratch/UAV/uav2017_dem/dems2017_detrendedmean_commongrid_399.nc')
