...
tn = 0
for t in dems.time:
	blurred = cv2.GaussianBlur(dems.Band1.sel(time=t).values, (999,999), 0)
...
blurred_xr.to_netcdf('/scratch/UAV/uav2017_dem/blur_fits_999.nc')
tmp_store = None
blurred_xr = None

# Load back in with dask
blurred = xr.open_dataset('/scratch/UAV/uav2017_dem/blur_fits_999.nc', 
	chunks={'y':2000, 'x':2000})

detrended = dems.Band1 - blurred.blurred
detrended.name = 'detrended'
detrended.to_netcdf('/scratch/UAV/uav2017_dem/dems2017_detrended_commongrid_999.nc')
detrended = None
...
detrended_mean.to_netcdf('/scratch/UAV/uav2017_dem/dems2017_detrendedmean_commongrid_999.nc')
detrended_mean = None
